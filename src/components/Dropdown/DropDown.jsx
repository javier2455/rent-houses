...
export const DropdownComponent = () => {
  ...
  return (
    ...
    size="sm"
    dismissOnClick={true}
    className="focus:ring-0 focus:bg-violet-700 focus:text-white bg-white hover:bg-violet-700 hover:text-white border border-violet-700 text-violet-700 transition"
    >
